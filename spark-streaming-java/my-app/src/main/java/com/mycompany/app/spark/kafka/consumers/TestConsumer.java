...
public class TestConsumer {
    ...
    public static void main(String[] args) throws InterruptedException{
        ...
        boolean yo = SentimentAnalysisComparisonManager.hasClearlyNegativeSentiment(te);
        int a = 1;
    }
